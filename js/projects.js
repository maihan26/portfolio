const projects = [
  {
    ...
    year: "2026",
    overview:
      "This project examines how Elk Creek and its surrounding habitat have changed since restoration began. Using GIS and remote sensing, the analysis focuses on stream sinuosity, lateral connectivity, and vegetation health.",
    problem:
    ...
    methods: [
      ...
      "Analyzed land cover and vegetation patterns",
      "Created maps and visual storytelling outputs"
    ],
    outcomes: [
      "Early signs of increased stream sinuosity",
      "Improved vegetation health in some areas",
  ...
  },
  {
    ...
    year: "2026",
    overview:
      "This project explores factors associated with medal success in the Winter Olympics, including sport opportunities, national factors, and athlete characteristics.",
    problem:
    ...
    methods: [
      ...
      "Examined athlete characteristics such as age, height, and weight",
      "Built visuals to communicate strategic insights"
    ],
    outcomes: [
      "Showed that medal success is sport-specific",
      "Highlighted sports with larger medal opportunities",
